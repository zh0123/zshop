...
<head>
    ...
    $(function(){
        ...
        $("#user-set").click(function() {
            $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/customerSysuser/findAll");
        });
            ...
            <div class="clear-bottom head">
                <div class="container head-cc">
                    ...
                    <div class="welcome">
                        ...
                        <div class="right"><%=session.getAttribute("name")%></div>
                        <div class="exit"><a href="http://localhost:9001/" style="color: black">退出</a> </div>
                    </div>
                </div>
            </div>
            <!-- header end -->
