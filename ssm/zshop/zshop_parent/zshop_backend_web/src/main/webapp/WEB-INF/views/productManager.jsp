    ...
    <script>
        ...
        function showProduct(id){
            $.post(
                ...
                function(result){
                    if(result.status==1){
                        $('#pro-num').val(result.date.id);
                        $('#pro-name').val(result.date.name);
                        $('#pro-price').val(result.date.price);
                        $('#pro-TypeId').val(result.date.productType.id);
                        $('#img2').attr('src','${pageContext.request.contextPath}/backend/product/getImage?path='+result.date.image);
                    }
                }
            );
        }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="product-price" class="col-sm-4 control-label">商品信息：</label>
                            <div class="col-sm-8">
